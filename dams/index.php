...
<html lang="en">
    <head>
        <title>MedBy Doctor Appointment System || Home Page</title>
                            ...
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="images/slider/slider1.jpg" class="img-fluid" alt="">
                                    </div>
                                    ...
                                    <div class="carousel-item">
                                        <img src="images/slider/slider3.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
...
{               ?>
                        ...
                        <div class="col-lg-4 col-md-5 col-12 mx-auto">
                            <div class="featured-circle bg-white shadow-lg d-flex justify-content-center align-items-center">
                                <p class="featured-text"><span class="featured-number">Med</span>By<br>We are here to serve you.</p>
                            </div>
                        </div>
...
<option value="">Select Doctor</option>
        ...
        <script src="/dams/js/voice.js"></script>
    </body>
</html>